...
impl ApiClient {
    pub fn new(server: &ResolvedServer, token: Option<String>) -> Result<Self> {
        Ok(Self {
...
pub fn save_credential(server_url: &str, token: &str) -> Result<()> {
...
pub async fn login(server: &ResolvedServer, save: bool) -> Result<ApiClient> {
