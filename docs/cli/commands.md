...
description: "Reference for every Dopbase CLI command in v0.0.14: connections, authentication, projects, environments, and secret operations."
---

# Command reference

This page defines the implemented v0.0.14 command surface. Dopbase does not infer a
...
```text
dopbase 0.0.14 is up to date (latest release 0.1.0).
```
