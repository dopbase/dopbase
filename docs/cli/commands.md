...
description: "Reference for every Dopbase CLI command in v0.1.1: connections, authentication, projects, environments, and secret operations."
---

# Command reference

This page defines the implemented v0.1.1 command surface. Dopbase does not infer a
...
```text
dopbase 0.1.1 is up to date (latest release 0.1.1).
```
