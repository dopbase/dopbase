...
Only one saved connection is active in v{{version}}. Logging in again, with a human
...
Only one endpoint can be globally active. v{{version}} does not retain named profiles
