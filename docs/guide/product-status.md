...
description: "What ships in Dopbase 0.1.2: the Rust server, CLI, Admin UI, REST API, and SQLite storage in one executable, plus current operational boundaries."
---

# Product status

Dopbase 0.1.2 is the current release. It includes the Rust server and
