...
description: "What ships in Dopbase 0.0.14: the Rust server, CLI, Admin UI, REST API, and SQLite storage in one executable, plus what is planned for 0.1.0."
---

# Product status

Dopbase 0.0.14 is the current testing release. It includes the Rust server and
